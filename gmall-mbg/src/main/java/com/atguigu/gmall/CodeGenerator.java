...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\IDEAworkpace\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("afei");
        ...
        dsc.setUrl("jdbc:mysql://47.93.191.23:3306/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
